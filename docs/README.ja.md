...
- [ ] **ノート共有機能**：クラウド上のノート의 공유 링크를 생성하여 자신의 성과를 다른 사람과 쉽게 공유할 수 있습니다.
...
1. プラグインのインストール (いずれかを選択)
   ...
   - **BRAT** を使用してインストール（モバイル対応）: Obsidian プラグインコミュニティ市場で [BRAT](https://github.com/TfTHacker/obsidian42-brat) プラグインを検索してインストール。プラグイン設定画面に入り、**Add beta plugin** をクリックし、https://github.com/haierkeys/obsidian-fast-note-sync を貼り付けます。
