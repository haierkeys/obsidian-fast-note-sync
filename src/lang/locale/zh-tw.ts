...
const zh_tw: Partial<LangMap> = {
  ...
  "setting.remote.client_name_desc": "為當前客戶端設置一个自定義名稱，用於多端同步時識別設備。",
  ...
  "setting.cloud.delete_after_upload": "附件雲預覽 - 上传后删除",
  "setting.cloud.delete_after_upload_desc": "附件成功上傳後將自動刪除本地文件以節省空間。\n(本設置需要開啟附件雲預覽)\n注意：請謹慎關閉，本项可能導致附件關聯插件失效。",
  ...
  "setting.support.log": "開啟日志",
  "setting.support.log_desc": "開啟後將在控制台打印日志",
  "setting.support.debug_copy": "複製 Debug 信息",
  "setting.support.debug_desc": "Debug 信息已複製到剪貼板, 敏感信息已脫敏處理",
  ...
  "setting.support.console_tip": "通過快捷鍵打開控制台，你可以看到這個插件和其他插件的日志",
