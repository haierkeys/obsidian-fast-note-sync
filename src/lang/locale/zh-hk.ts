...
const zh_hk: Partial<LangMap> = {
  ...
  "setting.sync.startup_delay_desc": "配置連接成功后延遲執行首次檢查更新的時間。\n如果你打開 Obsidian 時因為其他插件加載導致卡頓，可以嘗試設置此項。默認 500 毫秒",
