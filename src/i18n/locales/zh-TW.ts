...
export default {
  ...
  "ui.conflict.server_title": "服務端修改版本 (Remote)",
  "ui.conflict.final_title": "最終合併內容 (Final Content)",
  "ui.conflict.use_local": "使用本地內容",
  "ui.conflict.use_remote": "使用雲端內容",
  "ui.log.action.NoteManualMergeConflict": "手動合併衝突",
};
