...
export default {
  ...
  "setting.remote.setup_table": "\n| 方式 | 詳情參考 |\n| --- | --- |\n| 自己搭建  |  <a href='https://github.com/haierkeys/obsidian-fast-note-sync-service'>obsidian-fast-note-sync-service</a> 速度快，自由配置，無隱私風險 |",
  ...
  "setting.remote.mobile_status_dot_pos": "手機端服務連接狀態點",
  "setting.remote.mobile_status_dot_pos_desc": "設定手機端連接狀態小點的顯示位置或隱藏。",
  "setting.remote.mobile_status_dot_pos_hidden": "不顯示",
  ...
  "setting.remote.mobile_status_dot_pos_menu": "右上選單旁",
