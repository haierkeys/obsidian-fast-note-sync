...
export default {
  ...
  "ui.conflict.modal_desc": "The local and remote versions are read-only for comparison. Please edit the final content in the 'Resolved Conflict Version' on the far right, then click 'Resolve Conflict' below to save and submit.",
