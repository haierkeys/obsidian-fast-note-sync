...
export default {
  ...
  "setting.sync.config_dirs_desc": "In addition to core config sync, add special directories to sync (must start with <b>.</b>).\nNote: Paths NOT starting with <b>.</b> will be automatically ignored. All files in these directories will participate in sync, e.g., .claude.",
