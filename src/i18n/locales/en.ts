...
export default {
  ...
  "setting.sync.concurrency_control": "Concurrent Upload Control",
  "setting.sync.concurrency_control_desc": "When enabled, uses ACK messages from the server to precisely control the upload queue, preventing client lag from sudden request bursts. Disabled by default.",
  "setting.sync.max_concurrency": "Maximum Concurrent Uploads",
  "setting.sync.max_concurrency_desc": "Sets the number of simultaneous upload tasks. Recommended range: 3-10. Only applies when concurrent upload control is enabled.",
  "setting.sync.show_concurrency_indicator": "Show Concurrency Indicator",
  "setting.sync.show_concurrency_indicator_desc": "When enabled, displays an indicator icon in the bottom-right status bar while concurrent upload control is active.",
