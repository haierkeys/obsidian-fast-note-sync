...
export default {
  ...
  "setting.sync.merge_strategy_desc": "Content handling strategy when conflicts occur upon reconnecting to the server after offline editing of Markdown notes. This setting applies only to the local device.\n\n| Strategy | Description |\n| --- | --- |\n| No Merge, Keep Latest | Do not merge; retain only the most recently edited note. If the local note's edit time is older, local changes will be discarded after synchronization. |\n| Merge Only If Local Is Newer | Merge note content only if the local note's edit time is newer; otherwise, the server version takes precedence, and local changes will be discarded. |\n| Force Merge | Ignore edit order and force merge local and server note contents. |\n| Manual Merge | Do not auto merge, open a popup window for manual resolution on conflict. |\nNote: The merge process compares against the common base version, which may cause previously deleted content to reappear.",
  ...
  "ui.log.error_code.530": "Sync conflict detected. Please check the conflict copies generated in the vault. (Error code: ${code})",
  ...
  "ui.conflict.modal_title": "Conflict Merge",
  ...
  "ui.conflict.local_title": "Local Version (Local)",
  "ui.conflict.base_title": "Common Ancestor (Base)",
  "ui.conflict.server_title": "Server Version (Remote)",
  "ui.conflict.final_title": "Final Merged Content",
  "ui.conflict.use_local": "Use Local Content",
  "ui.conflict.use_remote": "Use Remote Content",
  "ui.log.action.NoteManualMergeConflict": "Manual Merge Conflict",
};
